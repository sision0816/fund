...
CREATE TABLE IF NOT EXISTS `fund_managers_chg` (
  `fund_code` varchar(255) NOT NULL COMMENT '基金代码',
  `start_date` varchar(255) DEFAULT NULL COMMENT '基金全称',
  `end_date` varchar(255) DEFAULT NULL COMMENT '基金简称',
  `fund_managers` varchar(255) DEFAULT NULL COMMENT '基金类型',
  `term` varchar(255) DEFAULT NULL COMMENT '发行日期',
  `return_rate` varchar(255) DEFAULT NULL COMMENT '成立日期',
  `created_date` varchar(255) DEFAULT NULL COMMENT '成立日期规模',
  `updated_date` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  `data_source` varchar(255) DEFAULT NULL COMMENT '成立日期',
  PRIMARY KEY (`fund_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='基金经理人信息表';

DROP TABLE IF  EXISTS fund_managers_info ;
CREATE TABLE IF NOT EXISTS `fund_managers_info` (
  `manager_id` varchar(255) NOT NULL COMMENT '基金代码',
  `url` varchar(255) DEFAULT NULL COMMENT '基金全称',
  `manager_name` varchar(255) DEFAULT NULL COMMENT '基金简称',
  `created_date` varchar(255) DEFAULT NULL COMMENT '基金类型',
  `updated_date` varchar(255) DEFAULT NULL COMMENT '发行日期',
  `data_source` varchar(255) DEFAULT NULL COMMENT '成立日期',
